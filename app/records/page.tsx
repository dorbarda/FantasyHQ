...
export default async function RecordsPage() {
  if (!hasEspnCredentials()) {
    return (
      <div className="py-5">
        <h1 className="text-[28px] font-bold tracking-tight text-[#0f1419] mb-2">Records</h1>
  ...
  if (error || !data) {
    return (
      <div className="py-5">
        <h1 className="text-[28px] font-bold tracking-tight text-[#0f1419] mb-2">Records</h1>
        <p className="text-[15px] text-[#536471]">Could not load records — try again later.</p>
      </div>
    );
  }
  ...
  return (
    <div className="py-5">
      {/* Header */}
      <div className="mb-5">
        <h1 className="text-[28px] font-bold tracking-tight text-[#0f1419]">Records</h1>
